...
var adjumanih = L.marker([3.375915, 31.790426], {icon: RCIcon}).bindPopup('<img height="50px" src="lib/zadjumani.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zadjumani.png">');
    ...
    nimuleh = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var adjumaniw = L.marker([3.375915, 31.790426], {icon: RCIcon}).bindPopup('<img height="50px" src="lib/zadjumani.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zadjumani.png">');
    ...
    nimulew = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var adjumaniG = L.marker([3.375915, 31.790426], {icon: RCIcon}).bindPopup('<img height="50px" src="lib/zadjumani.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zadjumani.png">');
    ...
    nimuleG = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var adjumaniR = L.marker([3.375915, 31.790426], {icon: RCIcon}).bindPopup('<img height="50px" src="lib/zadjumani.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zadjumani.png">');
    ...
    nimuleR = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var adjumaniP = L.marker([3.375915, 31.790426], {icon: RCIcon}).bindPopup('<img height="50px" src="lib/zadjumani.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zadjumani.png">');
    ...
    nimuleP = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var adjumaniT = L.marker([3.375915, 31.790426], {icon: RCIcon}).bindPopup('<img height="50px" src="lib/zadjumani.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zadjumani.png">');
    ...
    nimuleT = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var adjumaniA = L.marker([3.375915, 31.790426], {icon: RCIcon}).bindPopup('<img height="50px" src="lib/zadjumani.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zadjumani.png">');
    ...
    nimuleA = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var busiaTR = L.marker([0.468229, 34.090577], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/zbusia.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zbusia.png">');
    ...
    nimuleTR = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var nimuleF = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var adjumaniUNOPS = L.marker([3.375915, 31.790426], {icon: RCIcon}).bindPopup('<img height="50px" src="lib/zadjumani.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zadjumani.png">');
    ...
    nimuleUNOPS = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
    obockUNOPS = L.marker([11.964294, 43.293760], {icon: MCIcon}).bindPopup('<img height="50px" src="lib/zobock.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zobock.png">');
...
var adjumaniIOM = L.marker([3.375915, 31.790426], {icon: RCIcon}).bindPopup('<img height="50px" src="lib/zadjumani.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zadjumani.png">');
    ...
    nimuleIOM = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
...
var busiaTMEA = L.marker([0.468229, 34.090577], {icon: circleIcon}, {title: "busiaTMEA"}).bindPopup('<img height="50px" src="lib/zbusia.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/zbusia.png">');
    ...
    nimuleTMEA = L.marker([3.586098, 32.068238], {icon: circleIcon}).bindPopup('<img height="50px" src="lib/znimule.png">', {autoClose: false, closeOnClick: false}).bindTooltip('<img height="50px" src="lib/znimule.png">');
